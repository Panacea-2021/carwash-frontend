...
/* ═══════════════════════════════════════════════════════════════════════════
   MAIN COMPONENT
═══════════════════════════════════════════════════════════════════════════ */
const SupervisorActivityDetail = () => {
    ...
    async (silent = false) => {
      ...
      try {
        ...
        const [mainRes, allRes] = await Promise.all([
          api.get(`/supervisor-activities/supervisor/${supervisorId}?${qs}`),
          api.get(`/supervisor-activities/supervisor/${supervisorId}?${qsAll}`),
        ]);
        ...
        toast.error(
          err.response?.data?.message || "Failed to load supervisor activity",
        );
      } finally {
        setLoading(false);
      }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-purple-50/30 to-blue-50/20">
        <div className="text-center">
          ...
          <p className="text-slate-500">Loading supervisor analytics…</p>
        </div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600">Supervisor data not found.</p>
          <button
            onClick={() => navigate(-1)}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/20 to-blue-50/10 p-4 md:p-6 space-y-5">
                ...
                <div className="flex items-center gap-4 mt-1.5 flex-wrap text-xs text-slate-400">
                  ...
                  {supervisor?.createdAt && (
                    <span className="flex items-center gap-1">
                      ...
                      Joined: {fmtDate(supervisor.createdAt)}
                    </span>
                  )}
                </div>
              </div>
      ...
      <Card delay={0.24}>
        <div className="bg-gradient-to-r from-blue-500/10 via-cyan-500/10 to-teal-500/10 -m-5 p-5 rounded-t-2xl border-b-2 border-blue-200 mb-4">
          ...
          <p className="text-xs text-slate-600 mt-1 font-medium">
            In-depth analysis of supervisor&apos;s admin panel usage per page
          </p>
        </div>
      ...
      {/* ── 7. Supervisor Actions (CRUD) ─────────────────────────────────── */}
      <Card delay={0.25}>
        <SectionHeader
          icon={Settings}
          title="Supervisor Actions (CRUD)"
          color="text-sky-500"
      ...
      <Card delay={0.32}>
        <div className="bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10 -m-5 p-5 rounded-t-2xl border-b-2 border-indigo-200 mb-4">
          ...
          />
          <p className="text-xs text-slate-600 mt-1 font-medium">
            Complete supervisor journey from login to logout — with detailed
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div id={`sup-session-${i}`} className="space-y-2">
...
export default SupervisorActivityDetail;
